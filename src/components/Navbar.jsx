...
export const Navbar = ({menuOpen,setMenuOpen}) => {
    ...
    return <nav className="fixed top-0 w-full z-40 bg-[rgba(10,10,10,0.8)] backdrop-blur-lg border-b border-white/10 shadow-lg">
        <div className="max-w-screen ml-8 mr-16 px-4">
            <div className="flex justify-between items-center h-16">
               ...
               className="w-7 h-5 relative cursor-pointer z-40 mr-8 md:hidden">
                &#9776;
               </div>
               <div className="hidden md:flex items-center space-x-8">
                    ...
                    >
                     ...
                     <a href="#contact"
                    className="text-gray-300 hover:text-white transition-colors mr-8"
                    >
                    Contact
                    </a>
               </div>
